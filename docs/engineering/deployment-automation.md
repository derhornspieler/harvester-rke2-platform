...
| `OAUTH2_PROXY_COOKIE_SECRET` | *(random 32 chars)* | Yes | OAuth2 Proxy cookie encryption key (generated via `openssl rand -base64 32`) |
...
| `CHANGEME_OAUTH2_PROXY_CLIENT_SECRET` | `$OAUTH2_PROXY_CLIENT_SECRET` |
| `CHANGEME_OAUTH2_PROXY_COOKIE_SECRET` | `$OAUTH2_PROXY_COOKIE_SECRET` |
...
flowchart TD
    ...
    subgraph "Phase 2: OIDC Clients"
        ...
        C8 --> C9["Create client: oauth2-proxy<br/>redirect: auth.DOMAIN/oauth2/callback"]
